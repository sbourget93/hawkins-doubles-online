...
| `display_name` | Display name of the player, to be displayed in lieu of the player's first + last name. |
...
| `is_rado_willing` | Whether the player is willing to play "rado" |
