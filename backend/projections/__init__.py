...
from . import bounty, card, card_request, closest_to_pin, league_event, player, registration, team

_MODULES = (player, league_event, registration, closest_to_pin, card_request, card, team, bounty)
